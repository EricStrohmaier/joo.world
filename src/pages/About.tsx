          ...
          <div className="m-5 flex justify-center">
            <div className="text-lg space-y-4">
              ...
              <p>
                ...
                don't necessarily want to consume. In short, "it's about
              ...
              <p>
                It should be focused on creating (creating workflows; I don't
                know how that should look like yet), but creating long and
                short-form content, adding DVM options to it. For example, in
                the creation of a post, you could simply prompt an AI to create
                the image, etc.
              </p>
              <p>
                Creating lists, communities, creating a fanbase with less
                effort.
              </p>
              <p>
              ...
              <p>
                I will add my oneTask productivity tool where you will be able
                to answer goal/productive-oriented questions and choose if you
                want to post them or save to a private archive, where you can do
                a follow-up post with your progress of the goal and tag the
                post. Or you will have a dashboard with your weekly questions,
                etc. (I guess this would be already workflows?)
              </p>
            </div>
          </div>
        </LayoutCard>
